...
def build_answer_prompt(query: str, context: BuiltContext, analysis: SavAdminAnalysis) -> str:
    ...
    return (
        ...
        "12. Ne mentionne un client, une intervention ou un historique precis que si l'utilisateur le demande explicitement. "
        "Pour une question generale, une question sur ton identite/role, ou une question de suivi qui ne porte pas sur un cas precis, "
        "reponds sans exemple tire du contexte, meme si des sources sont disponibles.\n"
        "13. N'ecris jamais un numero de fiche ou de maintenance dans le corps du texte. Le seul renvoi vers une source autorise "
        "est le marqueur entre crochets [n] decrit ci-dessous.\n\n"
